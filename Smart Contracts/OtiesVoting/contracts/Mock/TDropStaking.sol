/**
 *Submitted for verification at thetatoken.org on 2022-01-25
 */
...
contract TDropStaking {
    ...
    uint public lastRewardMintHeight = 0; // the expected block height at 12pm Feb 1, 2022 PT. TODO: set proper initial value
    ...
    function unstake(uint rawShares) onlyWhenUnpaused external returns (uint) {
        ...
        // (poolTDropBalance() * sharesAmount) / totalShares
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(block.timestamp <= expiry, "TDropStaking::delegateBySig: signature expired");
